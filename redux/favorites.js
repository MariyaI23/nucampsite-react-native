...
//The includes method takes a single argument, in this case the action.apyload and checks to see if it matches a single item in the array. If so, ti will return with a boolean value of true, otherwise it will be false.
